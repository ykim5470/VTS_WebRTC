...
(function ($) {
    ...
    $.fn.nthTabs = function (options) {
        ...
        var tabCloseTxt = ['현재 탭 찾기', '현재 탭 닫기', '다른 탭 닫기', '모든 탭 닫기'];
        var template =
            '<div class="page-tabs">' +
        ...
        var methods = {
            ...
            addTab: function (options) {
                ...
                if(url.length>0){
                    tabContent.push('<iframe src="'+options.url+'" frameborder="0" name="iframe-'+frameName+'" class="nth-tabs-frame" title="nth탭으로 생성한 iframe"></iframe>');
                    frameName++;
                }else{
